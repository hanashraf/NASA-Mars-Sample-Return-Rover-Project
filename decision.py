...
def decision_step(Rover):
    ...
    if Rover.total_time < 3: 
    	Rover.home_x = Rover.pos[0]
    	Rover.home_y = Rover.pos[1]
	    
    elif Rover.total_time > 10:
    ...
    if Rover.nav_angles is not None:
        ...
        if Rover.mode[-1] == 'forward':
            ...
            elif Rover.samples_collected >= 5 and Rover.home_x < Rover.pos[0]+5 and Rover.home_y < Rover.pos[1]+5 and Rover.perc_mapped >= 95 :
